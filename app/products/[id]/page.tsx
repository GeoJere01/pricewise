...
const ProductDetails = async ({params: { id }}: Props) => {
  ...
  return (
    <div className="product-container">
          ...
          <div className="product-info">
            ...
            <div className="flex flex-col gap-4">
              ...
              <p className="text-sm text-black opacity-50">
                <span className="text-primary-green font-semibold">93%</span> of buyers are recommending this!
              </p>
            </div>
          </div>
      ...
      // Checking for similar data by first srapping those products with different id for the current item
